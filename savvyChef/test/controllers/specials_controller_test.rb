...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { ingredients: @special.ingredients, instructions: @special.instructions, title: @special.title }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { ingredients: @special.ingredients, instructions: @special.instructions, title: @special.title }
    assert_redirected_to special_path(assigns(:special))
  end
